...
var edges = [
    ...
    { from: 1, to: 5 }, // Beata -> Fryderyk
    { from: 1, to: 6, color: "green" }, // Beata -> Grzegorz
    { from: 1, to: 8 }, // Beata -> Igor
    { from: 2, to: 5, color: "green" }, // Celina -> Fryderyk
    { from: 3, to: 6 }, // Dorota -> Grzegorz
    { from: 3, to: 8, color: "green" }, // Dorota -> Igor
    { from: 3, to: 9, color: "red" }, // Dorota -> Jan
...
var container = document.querySelector('.graph-marriage-seventh-step');
